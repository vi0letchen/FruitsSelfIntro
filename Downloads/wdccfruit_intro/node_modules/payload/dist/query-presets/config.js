...
export const getQueryPresetsConfig = (config)=>({
        ...
        fields: [
            ...
            },
            {
                ...
                type: 'checkbox',
                admin: {
                    description: "This is a tempoary field used to determine if updating the preset would remove the user's access to it. When `true`, this record will be deleted after running the preset's `validate` function.",
                    disabled: true,
                    hidden: true
                }
            }
