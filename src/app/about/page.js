export default function About() {
     return (
       ...
       style={{ backgroundImage: "url('aurora.jpg')" }}>
         ...
         <h1 className="text-3xl font-bold mb-4 p-10">My Top 3 Songs 🎶</h1>
         <ul className="list-disc pl-5 space-y-2">

            <div className="mt-4">
              
                <img src="/tate.jpg" alt="TateMcRae" className="w-full max-w-100 h-auto rounded-md" />
           ...
           <div className="mt-4">
                <img src="/sza.jpg" alt="SZA" className="w-full my-5 max-w-100 h-auto rounded-md" />
           ...
           <div className="mt-4">
                <img src="/billie.jpg" alt="BillieEllish" className="w-full my-5 max-w-100 h-auto rounded-md" />
